...
class Novo(QMainWindow, Ui_MainWindow):
    def __init__(self, parent=None):
        ...
        self.btnRedimensionar.clicked.connect(self.redimensionar_img)
        self.btnSalvar.clicked.connect(self.salvar_img)

    def abrir_imagem(self):
        imagem, _ = QFileDialog.getOpenFileName(
            self.centralwidget,
            "Abrir Imagem",
            r'\Users\Reinan\Pictures',
