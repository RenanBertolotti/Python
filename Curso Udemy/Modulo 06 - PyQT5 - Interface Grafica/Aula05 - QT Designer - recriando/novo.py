...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.botao1.setGeometry(QtCore.QRect(190, 200, 75, 23))
        self.botao1.setObjectName("botao1")
        self.botao2 = QtWidgets.QPushButton(self.centralwidget)
        self.botao2.setGeometry(QtCore.QRect(310, 200, 91, 21))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.botao1.setText(_translate("MainWindow", "Clique Aqui"))
        self.botao2.setText(_translate("MainWindow", "Nao clique aqui"))
