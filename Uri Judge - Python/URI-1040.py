...
media_peso = ((nota1*2) + (nota2*3) + (nota3*4) + (nota4*1)) / (2 + 3 + 4 + 1)

print(f"Media: {media_peso:.1f}")
...
if media_peso >= 7.0:
    ...
    nova_prova = float(input())

    print(f"Nota do exame: {nova_prova:.1f}")

    nova_media = (media_peso + nova_prova) / 2
